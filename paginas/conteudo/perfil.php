...
if ($row) {
  ...
  // Trate o caso em que não há resultados para a consulta
...
?>
              ...
              if (isset($_POST['upPerfil'])) {
                ...
                $data_nascimento = $row['data_nascimento']; // Armazena a idade do usuário
                $foto_user = $row['foto_user']; // Armazena a foto do usuário
            ...
            <div class="card">
              ...
              <div class="card-body p-0" style="text-align: center; margin-bottom: 98px">
                ...
                if ($show->foto_user == 'avatar-padrao.png') {
                    ...
                    echo '<img src="../img/cont/' . $show->foto_user . '" alt="' . $show->foto_user . '" title="' . $show->foto_user . '" style="width: 250px; border-radius: 100%; padding-top:15px">';
                }
                ?>    
