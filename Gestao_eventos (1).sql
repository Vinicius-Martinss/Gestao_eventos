...
CREATE TABLE `Eventos` (
  ...
  `id_local` varchar(150) DEFAULT NULL,
  PRIMARY KEY (`EventoID`),
  KEY `CriadorID` (`CriadorID`),
  KEY `TipoID` (`TipoID`),
  KEY `id_user` (`id_user`),
  KEY `fk_user` (`id_local`),
  ...
  CONSTRAINT `fk_user` FOREIGN KEY (`id_local`) REFERENCES `Locais` (`local_evento`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `Eventos` VALUES (1,'Aniversário do vinicius','aniversário do vinicius','2024-10-25 19:00:00','2024-10-25 21:00:00',1,1,NULL,NULL,NULL);
...
INSERT INTO `Inscricoes` VALUES (1,1,1,'2024-08-28 00:00:00');
...
INSERT INTO `Locais` VALUES (1,'Casa do Vinicius','rua sei lá onde','ceará','pacajus','62870000');
...
INSERT INTO `Participantes` VALUES (1,'Gabriel Levi','gabriellevisantosteixeira04171@gmail.com','(85) 9 9264-8353');
...
INSERT INTO `TiposEvento` VALUES (1,'Aniversário');
...
INSERT INTO `tb_user` VALUES (1,'Gabriel Levi','gabriellevisantosteixeira04171@gmail.com','12345678',''),(2,'vini','viniciusmartinsgsi@gmail.com','$2y$10$1X5oqMHXmIJZ4iYBLaJaMejvOYyJOuN71oxCyApVuCkIDzeyf5hx2','avatar-padrao.png');
...
-- Dump completed on 2024-09-04  8:42:06
