...
?>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="home.php?acao=perfil" title="Perfil e Saída">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="../img/logo.jpeg" alt="Logo" style="height: 30px; margin-left: 10px; border-radius:
      50%">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="home.php?acao=evento" class="nav-link">
          ...
          <li class="nav-item">
            <a href="home.php?acao=participante" class="nav-link">
